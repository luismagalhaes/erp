...
/// <summary>The Inventory module's tables, declared by the module itself.</summary>
public sealed class InventoryModelConfiguration : IModuleModelConfiguration
{
    public void Configure(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<StockBalance>(entity =>
        {
            ...
            entity.Property(x => x.ProductDescription).HasMaxLength(200).IsRequired();
            entity.Property(x => x.Quantity).HasPrecision(19, 6);
            entity.Property(x => x.AverageCost).HasPrecision(19, 6);
            entity.Property(x => x.StockValue).HasPrecision(19, 6);
