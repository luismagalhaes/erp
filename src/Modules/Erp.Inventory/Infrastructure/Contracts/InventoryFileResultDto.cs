...
/// How many reported products no source could put a cost on, and so are worth nothing in the
/// valuation. Only counted on the valued file, the one that has to carry a figure.
/// </param>
/// <param name="ProductsCostedFromFile">
/// How many fell back to the standard cost on the product file, because the ledger never observed
/// a cost for them. Worth knowing: the acquisition cost is what the law wants, and the standard
/// cost is a stand-in for stock that entered before any purchase recorded one.
/// </param>
