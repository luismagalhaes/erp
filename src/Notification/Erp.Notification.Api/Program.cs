using Erp.Notification.Api.Authorization;
...
Log.Information("Starting Erp.Notification.Api...");
...
try
{
    ...
    if (app.Environment.IsDevelopment())
    {
        ...
        {
            options.Title = "ERP Notification API";
        });
...
{
    Log.Fatal(ex, "Failure during Notification.Api startup");
}
finally
{
    Log.CloseAndFlush();
