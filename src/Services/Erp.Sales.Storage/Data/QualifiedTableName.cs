...
/// <summary>
/// Where an entity is mapped, quoted for SQL Server. Needed by the few statements that drop to SQL
/// to take a lock hint, and read from the model so a literal cannot drift away from the mapping.
/// </summary>
